...
obama_image = face_recognition.load_image_file("images/deva.jpg")
obama_face_encoding = face_recognition.face_encodings(obama_image)[0]

sam_image = face_recognition.load_image_file("samyuktha.jpg")
sam_face_encoding = face_recognition.face_encodings(sam_image)[0]

# Load a second sample picture and learn how to recognize it.
biden_image = face_recognition.load_image_file("images/arul.jpg")
